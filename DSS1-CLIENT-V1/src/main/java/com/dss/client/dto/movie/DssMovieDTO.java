...
public class DssMovieDTO {
    ...
    public List<ImagesDTO> getImage() {
        return image;
    }

    public void setImage(List<ImagesDTO> image) {
        this.image = image;
    }
